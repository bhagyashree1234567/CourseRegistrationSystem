	...
	<div style="background:linear-gradient(to bottom, #990033 0%, #ff6666 100%);height: 500px;padding-top:0;">
		...
		<div >
			<?php
				...
				$selectquery="select * from faculty_info where username='$uname' and password='$pwd'";
				...
				if(mysqli_num_rows($ResourceID)){
					...
					echo "<h4 style='margin:30px;color:white;'><a href='fac_login.php'>Click Here To Login again</a></h4>";
				}
			?>
		</div>
	</div>
